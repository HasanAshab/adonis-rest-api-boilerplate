...
export default class MongoDBAuthProvider<IUser extends object> implements UserProviderContract<IUser> {
  private model?: Model;
  
  constructor(public config: MongoDbAuthProviderConfig<IUser>, private hash: HashContract) {}
