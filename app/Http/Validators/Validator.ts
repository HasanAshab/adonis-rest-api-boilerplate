...
export default class Validator {
	...
	public messages: CustomMessages = {
		...
		minLength:
			'{{ field }} field must have at least {{ options.minLength }} characters.',
		range:
			'{{ field }} field must be within the range of {{ options.min }} and {{ options.max }}.',
		...
		afterField:
			'{{ field }} field must be a date after {{ options.afterField }} field.',
		beforeField:
