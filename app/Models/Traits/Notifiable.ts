...
export interface NotifiableDocument<
	DocType extends NotifiableDocument<any> = any,
> extends Document {
	notifications: QueryWithHelpers<
		NotificationDocument[],
		NotificationDocument,
		NotificationQueryHelpers
	>;
	unreadNotifications: QueryWithHelpers<
		NotificationDocument[],
		NotificationDocument,
		NotificationQueryHelpers
	>;
...
export default (schema: Schema) => {
	...
	schema.methods.notify = async function (
		notification: NotificationClass<NotifiableDocument>,
	) {
