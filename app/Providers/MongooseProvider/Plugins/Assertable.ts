...
interface AssertedQuery<TRawDocType, TQueryHelpers = {}>
	extends Query<TRawDocType, TRawDocType, TQueryHelpers> {}
...
declare module 'mongoose' {
	interface Model<TRawDocType, TQueryHelpers = {}> {
		where(field: string): {
			equals(
				value: any,
			): Query<TRawDocType[] | null, TRawDocType, TQueryHelpers>;
		};
		updateOneById(id: string, data: object): Promise<boolean>;
		deleteOneById(id: string): Promise<boolean>;
		findOneOrFail(
			...args: Parameters<this['findOne']>
		): AssertedQuery<TRawDocType, TQueryHelpers>;
		findOneAndUpdateOrFail(
			...args: Parameters<this['findOneAndUpdate']>
		): AssertedQuery<TRawDocType, TQueryHelpers>;
		findOneAndReplaceOrFail(
			...args: Parameters<this['findOneAndReplace']>
		): AssertedQuery<TRawDocType, TQueryHelpers>;
		findOneAndReplaceOrFail(
			...args: Parameters<this['findOneAndReplace']>
		): AssertedQuery<TRawDocType, TQueryHelpers>;
		...
		findByIdAndUpdateOrFail(
			...args: Parameters<this['findByIdAndUpdate']>
		): AssertedQuery<TRawDocType, TQueryHelpers>;
		findByIdAndRemoveOrFail(
			...args: Parameters<this['findByIdAndRemove']>
		): AssertedQuery<TRawDocType, TQueryHelpers>;
		...
		new Promise<Document>((resolve, reject) => {
			fetchDocument(op)
				...
				.then((doc) => {
					...
					reject(
						new DocumentNotFoundException(query.mongooseCollection.modelName),
					);
				});
		});
}
...
export default function Assertable(schema: Schema) {
	schema.statics.findOneOrFail = function (
		...args: Parameters<Model<Document>['findOne']>
	) {
	...
	schema.statics.findOneAndUpdateOrFail = function (
		...args: Parameters<Model<Document>['findOneAndUpdate']>
	) {
	...
	schema.statics.findOneAndReplaceOrFail = function (
		...args: Parameters<Model<Document>['findOneAndReplace']>
	) {
	...
	schema.statics.findOneAndDeleteOrFail = function (
		...args: Parameters<Model<Document>['findOneAndDelete']>
	) {
	...
	schema.statics.findByIdAndUpdateOrFail = function (
		...args: Parameters<Model<Document>['findByIdAndUpdate']>
	) {
	...
	schema.statics.findByIdAndRemoveOrFail = function (
		...args: Parameters<Model<Document>['findByIdAndRemove']>
	) {
	...
	schema.statics.updateOneByIdOrFail = async function (
		id: string,
		data: object,
	) {
