...
ApiResponse.macro('assertBodyContainProperty', function(this: ApiResponse, property: string, subset: object) {
  this.ensureHasAssert()
...
ApiResponse.macro('assertBodyHaveProperty', function(this: ApiResponse, property: string, value?: unknown) {
  this.ensureHasAssert()
  const recieved = get(this.body(), property)
