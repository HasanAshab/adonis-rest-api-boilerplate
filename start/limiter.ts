...
export const highThrottle = limiter.define('high', () => limiter.allowRequests(50).every('1 hour'))
...
export const lowThrottle = limiter.define('low', () => limiter.allowRequests(100).every('1 min'))
